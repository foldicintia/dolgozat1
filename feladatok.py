...
# 1. feladat: Kérj be 1 páros számot a felhasználótól. (1 pont)
...
def feladat1():
    ...
    while not (szam%2 ==0):
        print("Hiba! A megadott szám nem páros. ")
        szam: int = int(input("Adj meg egy páros számot!: "))
    print(szam)


# 2.feladat: Írass ki a konzolra 13 db  [10, 150] zárt intervallumba eső véletlen számot. Hány 3-mal osztható van közöttük? 
...
# 3. feladat: Írj eljárást, mely paraméterként kap egy text szöveget, és egy N számot. 
...
def feladat3(txt:str, n:int):
    ...
    if len(txt)<n:
        ...
        print(f"A szöveg {n}. karaktere {txt[n]} - {txt[n].upper()*3}")



# 4. feladat: Írj metódust, mely neveket kér a felhasználótól, amíg a @ jelet nem kapja.
...
def feladat4():
    ...
    while not(nev=="@"):
        nev: str = str(input("Adj meg egy nevet!:"))
        gyujto += 1
    print(f"A felhasználó {gyujto} nevet adott meg")



# 5. feladat: Szimuláljuk a kő-papír-olló játékot. 
# Írj eljárást, amiben: 
...
def feladat5():
    print("5. feladat")
    tipp: str(input("Tippeljen! kő/papír/olló: "))
